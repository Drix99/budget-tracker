                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" placeholder="e.g., Groceries, Salary" class="w-full px-3 py-2 border {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300 dark:border-gray-600' }} rounded" required value="{{ old('name') }}">
                            @error('name')
